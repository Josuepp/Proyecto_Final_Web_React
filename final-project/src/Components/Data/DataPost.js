...
const DataPost = ({ id, tittle, description, img, likes, group, tokenSession, getUserData, getFavoriteData, comments, date }) => {
    ...
    const makeComment = async () => {
        const commentMade = document.getElementById(id).value;
        ...
        <div className="w-72  mx-2 relative bg-white rounded-lg py-2 shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-105 cursor-pointer">
            <div className="flex items-center mb-2 space-x-4">
                ...
                <div className="ml-7">
                    ...
                    <h1 className="mb-1 h-12 text-md font-bold text-gray-700"> {tittle}</h1>
            ...
            <div>
                ...
                <div class=" flex">
                    <input id={id} className=" w-full text-sm font-thin  px-5 py-2 mb-2 bg-gray-50 outline-none rounded-full border-1" type="text" placeholder="Enter your comment" />
