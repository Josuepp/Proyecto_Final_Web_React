        ...
        <div class="w-72  mx-2 relative bg-white rounded-lg py-2 shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-105 cursor-pointer">
            <div class="flex items-center mb-2 space-x-4">
                ...
                <div className="ml-7">
                    ...
                    <h1 class="mb-1 h-12 text-md overflow-auto font-bold text-gray-700"> {tittle}</h1>

                    <div className="h-20 overflow-auto"><p class="text-sm font-normal h-16 text-gray-600  hover:underline">{description}</p></div>
