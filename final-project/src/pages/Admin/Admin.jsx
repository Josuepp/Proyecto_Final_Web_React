...
export default function Admin() {
    ...
    ************************************************************************* */ }
                ...
                <div class="p-8 flex flex-wrap justify-center gap-4 bg-gray-300  ">
                    <h1 className="text-6xl font-bold mb-8">Mis post</h1>
                ...
                ************************************************************************* */ }
                ...
                <div class="p-8 flex flex-wrap justify-center gap-4 ">
                    <h1 className="text-4xl font-bold">Todos los post</h1>
                    <div className="w-full flex justify-center  items-center gap-16  flex-wrap">
                        {
                ...
                <div className="w-full  flex justify-between px-16 mb-16 mt-8">
                    <ButtonBack onClick={() => { handlerButton("back", "user") }} />
                    <ButtonNext onClick={() => { handlerButton("next", "user") }} />
                </div>

                <div className=" w-full">
                    <h1 id="formPost" className="text-center text-4xl font-bold">Agregar post</h1>
